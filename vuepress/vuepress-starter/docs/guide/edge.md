...
2. 点击下方链接进入 **Microsoft Edge 加载项商店**：
   - [Tampermonkey - Microsoft Edge Addons](https://www.google.com/search?q=https://microsoftedge.microsoft.com/addons/detail/tampermonkey/iikmkjmpaadaobahmlepeloendndfphd)
3. 在页面右侧点击蓝色的 **“获取 (Get)”** 按钮。
4. 浏览器上方会弹出一个提示框，点击 **“添加扩展 (Add extension)”**。
5. 等待几秒钟，安装完成后，您会在浏览器右上角的工具栏看到一个黑色的图标 !。
...
1. 打开任意一个包含视频的网站（例如 Bilibili 或 YouTube），或者打开一个 Unity 网页游戏。

2. 观察页面 **左上角**，您应该能看到一个半透明的黑色悬浮窗，上面写着 **“⚡ 全局加速”**。
